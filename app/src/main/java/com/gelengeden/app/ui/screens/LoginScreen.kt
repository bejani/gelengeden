...
fun LoginScreen(
    ...
    LaunchedEffect(uiState.phase) {
        // Clear fields when switching between setup / login
        password = ""
        confirmPassword = ""
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = stringResource(
                    if (isSetup) R.string.login_setup_title else R.string.login_title
                ),
            ...
            Text(
                text = stringResource(
                    if (isSetup) R.string.login_setup_subtitle else R.string.login_subtitle
                ),
